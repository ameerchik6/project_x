...
AccountList = [
    {
        ...
        "Authorization": "Bearer 1719268810798V8lRbpUmAaYYtMySUzZ0BSnUJlN6HWefJmaQvB4KIjY90zUvZQKnLXd3DK8mVWKr5527705092",  # To get the token, refer to the README.md file
    ...
    },
    {
        ...
        # If you do not wish to use this feature for this account, leave it empty.
        # This feature is optional and is required to enable the telegramBotLogging feature below.
        "telegram_chat_id": "7489177485",  # String - you can get it from https://t.me/chatIDrobot
    },
    # {
...
telegramBotLogging = {
    ...
    "bot_token": "7318243023:AAGlulIAjYzncImUpVWxabHLllmBWuj9JBQ",  # HTTP API access token from https://t.me/BotFather ~ Start your bot after creating it
